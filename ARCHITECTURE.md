...
The other direction from the phase 1 entry above (this one landed after the
tote entry between them, so "above" is no longer adjacent). A clause naming a position inside
